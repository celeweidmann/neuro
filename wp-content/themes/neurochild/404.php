...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		<main id="main" class="site-main page col-full" role="main">
				...
				<div class="page-content">
					...
					if ( storefront_is_woocommerce_activated() ) {
						...
						echo '<div class="row">';
							...
							echo '<section class="col-md-8" aria-label="' . esc_html__( 'Promoted Products', 'storefront' ) . '">';							
							...
							echo '<nav class="col-md-4" aria-label="' . esc_html__( 'Product Categories', 'storefront' ) . '">';
